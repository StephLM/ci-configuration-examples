[![MATLAB](https://github.com/StephLM/ci-configuration-examples/actions/workflows/
ci.yml/badge.svg)](https://github.com/StephLM/ci-configuration-examples/actions/
workflows/ci.yml)
